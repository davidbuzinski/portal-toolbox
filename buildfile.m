...
plan("mex:maca64") = MexTask("src/getCake.c", "toolbox/+portal", Filename="getCake.mexmaci64", Options="TARGET=maca64");
plan("mex:maci64") = MexTask("src/getCake.c", "toolbox/+portal", Filename="getCake.mexmaca64", Options="TARGET=maci64");
